function result_HC = PV_HostingCapacity_NoQControl(Cap_init_kW, Cap_step_kW, Cap_max_kW)
%PV_HostingCapacity_NoQControl
% 无无功电压控制下的光伏承载力评估
%
% 外层循环：逐步增加光伏容量
% 内层模型：给定光伏容量，求解无无功控制下的配电网运行状态
...
while cap_kW <= Cap_max_kW
    ...
    %% 内层：无无功电压控制
    result = NoQControlcapacity(cap_kW);
...
result_HC.control_mode = "No reactive voltage control";
